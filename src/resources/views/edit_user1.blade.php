                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="tab1">
                                ...
                                <div class="form-group">
                                    <label for="first_name" class="col-sm-2 control-label">Full Name *
                                    </label>
                                    <div class="col-sm-10">
                                        <input id="first_name" name="first_name" type="text" placeholder="Full Name" value="" class="form-control required" value="Addison" />
                                    </div>
                                </div>
                                <div class="form-group">
