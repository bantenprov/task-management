<div class="nav_profile">
    <div class="media profile-left">
        <a class="pull-left profile-thumb" href="{{ route('userProfileIndex') }}">
...
<ul class="navigation slimmenu" id="navigation">    
    <li {!! (Route::is( 'taskManagementIndex') ? 'class="active"': "") !!}>
    ...
    <li {!! (Route::is('taskManagementCommentIndex') || Route::is('taskManagementCommentShow') ? 'class="active"': "") !!}>
    ...
    <li {!! (Route::is( 'taskManagementMemberIndex') || Route::is( 'taskManagementMemberCreate') || Route::is( 'taskManagementMemberEdit') || Route::is( 'taskManagementMemberShow') ? 'class="active"': "") !!}>
        <a href="{{route('taskManagementMemberIndex')}}">
            <i class="menu-icon ti-user"></i>
            <span class="mm-text ">Member</span>
        </a>
    </li>
    <li {!! (Route::is( 'taskManagementProjectIndex')|| Route::is( 'taskManagementProjectCreate') || Route::is( 'taskManagementProjectShow')? 'class="active"': "") !!}>
        <a href="{{route('taskManagementProjectIndex')}}">
            <i class="menu-icon ti-ruler-pencil"></i>
            <span class="mm-text ">Project</span>
        </a>
    </li>
    <li {!! (Route::is( 'taskManagementStafIndex')|| Route::is( 'taskManagementStafCreate') || Route::is( 'taskManagementStafShow')? 'class="active"': "") !!}>
        <a href="{{route('taskManagementStafIndex')}}">
            <i class="menu-icon ti-id-badge"></i>
            <span class="mm-text ">Staf</span>
        </a>
    </li>
    <li {!! (Route::is('taskManagementTaskIndex') || Route::is( 'taskManagementTaskCreate') || Route::is('taskManagementTaskShow') || Route::is('taskManagementTaskAddMember') ? 'class="active"': "") !!}>
        <a href="{{route('taskManagementTaskIndex')}}">
            <i class="menu-icon ti-clipboard"></i>
            <span class="mm-text ">Task</span>
        </a>
    </li>
    
    <li {!! (Route::is( 'userManagementIndex') || Route::is( 'userManagementCreate') || Route::is('userManagementIndex') || Route::is('userManagementIndex') ? 'class="active"': "") !!}>
        <a href="{{route('userManagementIndex')}}">
            <i class="menu-icon ti-user"></i>
            <span class="mm-text ">User Management</span>
        </a>
    </li>    

    <li {!! (Route::is( 'opdIndex') || Route::is( 'opdCreate_root') || Route::is('opdAddChild') || Route::is('opdShow') ? 'class="active"': "") !!}>
        <a href="{{ route('opdIndex') }}">
            <i class="menu-icon ti-layers-alt"></i>
            <span class="mm-text ">OPD</span>
        </a>
    </li>
    

    <li {!! (Request::is( 'role') || Request::is( 'realtime_form') || Request::is( 'form_validations') || Request::is( 'form_layouts') || Request::is( 'complex_forms')|| Request::is( 'complex_forms2') || Request::is( 'radio_checkboxes') || Request::is( 'form_editors') || Request::is( 'form_wizards') || Request::is( 'dropdowns') || Request::is( 'datepicker') ||Request::is( 'advanceddate_pickers') ||Route::is('permission') ||Route::is('role') ? 'class="menu-dropdown active"': 'class="menu-dropdown"') !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Route::is( 'role') || Route::is( 'opdCreate_root') || Route::is('opdAddChild') || Route::is('opdShow') ? 'class="active"': "") !!}>
                <a href="{{ route('role') }}">
                    <i class="menu-icon ti-lock"></i>
                    <span class="mm-text ">Role</span>
                </a>
            </li>   
            <li {!! (Route::is( 'permission') || Route::is( 'opdCreate_root') || Route::is('opdAddChild') || Route::is('opdShow') ? 'class="active"': "") !!}>
    ...
    <li {!! (Route::is( 'accessControlIndex') || Route::is( 'accessControlIndex') || Route::is('accessControlIndex') || Route::is('accessControlIndex') ? 'class="active"': "") !!}>
        <a href="{{ route('accessControlIndex') }}">
            <i class="menu-icon ti-key"></i>
            <span class="mm-text ">Access Control</span>
        </a>
    </li>
    ...
    <li {!! (Request::is( 'form_elements') || Request::is( 'realtime_form') || Request::is( 'form_validations') || Request::is( 'form_layouts') || Request::is( 'complex_forms')|| Request::is( 'complex_forms2') || Request::is( 'radio_checkboxes') || Request::is( 'form_editors') || Request::is( 'form_wizards') || Request::is( 'dropdowns') || Request::is( 'datepicker') ||Request::is( 'advanceddate_pickers') ||Request::is( 'x-editable') ||Request::is( 'jstree') ? 'class="menu-dropdown active"': 'class="menu-dropdown"') !!}>
        ...
        <ul class="sub-menu">
            <li {!! (Request::is( 'form_elements') || Request::is( 'realtime_form') ? 'class="active"': 'class=""') !!}>
                <a href="javascript:void(0)">
